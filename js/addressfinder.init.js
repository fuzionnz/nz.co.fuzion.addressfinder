      ...
      var init = function(el, id) {
        ...
        widget.on('result:select', function(fullAddress, metaData) {
          if (COUNTRY_ID == 1154) {
            ...
            // setValueAndDisable($('#address_' + id + '_supplemental_address_1', el), address.suburb);
    ...
    if (profile.length > 0 && street_addr_field.length > 0) {
      ...
      widget.on('result:select', function(fullAddress, metaData) {
        if (COUNTRY_ID == 1154) {
          ...
          // $('#supplemental_address_1-' + loctype, profile).val(selected.suburb());
